		...
		<div class="col-md-8">
			<div class="card card-outline card-primary">
				<div class="card-header">
					...
					<div class="card-tools">
						<a class="btn btn-primary bg-gradient-primary btn-sm" href="./index.php?page=new_task&pid=<?php echo $id?>" type="button" id="new_task"><i class="fa fa-plus"></i> New Task</a>
						<!-- <a class="btn btn-primary bg-gradient-primary btn-sm" href="./project/index.php" type="button" id="new_task"><i class="fa fa-plus"></i> New Task</a> -->
					</div>
				<?php endif; ?>
				</div>
